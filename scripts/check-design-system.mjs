...
const EXCLUES = new Map([
  ...
  ["nav-infos", "entree deployante du menu, indissociable du chrome de page"],
  ["nav-infos-toggle", "entree deployante du menu, indissociable du chrome de page"],
  ["chev", "chevron de l entree deployante, indissociable du chrome de page"],
  ["mega", "panneau du menu Infos, indissociable du chrome de page"],
  ["mega-col", "colonne du panneau du menu Infos, indissociable du chrome de page"],
  ["mega-intro", "colonne de tete du panneau du menu Infos, indissociable du chrome de page"],
  ["mega-lien", "lien du panneau du menu Infos, indissociable du chrome de page"],
